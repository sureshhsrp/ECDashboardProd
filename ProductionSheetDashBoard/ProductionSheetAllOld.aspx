<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionSheetAllOld.aspx.cs" Inherits="ProductionSheetDashBoard.ProductionSheetAllOld" %>
...
<asp:Button ID="btnPreview" runat="server" CssClass="button" BackColor="Green" ForeColor="#ffffff"
                            ...
                            <asp:Button ID="Button1" runat="server" CssClass="button" BackColor="Green" ForeColor="#ffffff"
